      ...
      <ul>
        <div className="flex items-center">
          ...
          <div className="flex flex-col ml-2">
            <span className="font-medium text-[16px] text-[#292D32]">
              Pressão arterial
            </span>
            <span className="font-regular text-[13px] text-[#292D32]">
              &le; 70
            </span>
          </div>
        </div>
        ...
        <div className="flex flex-col relative bg-[#EDF0F6] px-3 py-4 rounded-[16px] mt-16">
          ...
          <span className="font-regular text-[12px] text-[#404852]">
            Manter o paciente em monitorização constante e assistência
            multiprofissional
          </span>
          ...
          <div className="flex mt-5 justify-center">
            <button
              ...
              type="submit"
              className="block rounded-md bg-[#1d1d1d] px-3.5 py-2.5 text-center  text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2  w-[100%] self-center">
              Mais informações
            </button>
          </div>
        </div>
